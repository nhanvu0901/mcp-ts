...
from langchain_openai import OpenAIEmbeddings  # Changed from AzureOpenAIEmbeddings
import uvicorn
...
def get_embedding_model():
    ...
    return OpenAIEmbeddings(
        ...
        openai_api_base=f"{litellm_proxy_url}/v1",
        openai_api_key=litellm_app_key,
        timeout=30.0,
        max_retries=3
    )
